...
# FROM: wasd.py FROM SEBASTIAN JOAQUIN TO SEBASTIAAN JOAQUIN


## HOW TO RUN------------------------

# IF THE GAME DOES.NT WORK MAKE SURE PYTHON RUNS IT IN TERMINAL NOT HERE IN PYCHARM OR GO TO MORE RUN /DEBUG AND MODIFY RUN
...
# VERSION 1.1
# ADDED: 
# - harder goblin positions(unknown)
# - more controls (e - see positions)
# - better menu
# - You have to go get him 5 times
# - better end screen




# LINE 27 IS THE ONLY AI(AND THE PARTS RELATED TO IT)
